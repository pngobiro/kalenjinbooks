-- Seed data for Kalenjin Books platform (Authors and Books only)
-- Using INSERT OR IGNORE to avoid conflicts with existing users

-- Authors
INSERT OR IGNORE INTO Author (id, userId, bio, profileImage, createdAt, updatedAt) VALUES
...
-- Books
INSERT OR IGNORE INTO Book (id, title, description, coverImage, fileKey, fileSize, fileType, price, previewPages, category, language, isPublished, publishedAt, authorId, createdAt, updatedAt) VALUES
...
-- Blog Posts
INSERT OR IGNORE INTO BlogPost (id, title, slug, content, excerpt, coverImage, isPublished, publishedAt, viewCount, authorId, createdAt, updatedAt) VALUES
